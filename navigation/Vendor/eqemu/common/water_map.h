...
public:
	...
	virtual bool PotentiallyBlocked(const glm::vec3& low, const glm::vec3& high) const { return true; }
	static bool BlocksWalking(int t) { return t==1 || t==2 || t==3 || t==5 || t==7 || t==10 || t==-2; }
