...
bool Map::Build(std::string zone_name, bool ignore_collide_tex) {
	...
	if (atlas_format == "eqg" && eqg.Load(zone_name, eqg_models, eqg_placables, eqg_regions, eqg_lights)) {
